...
2. **Fargate Spot Pricing (-$90/mo):** Instead of running On-Demand EC2 instances, the algorithms run on Fargate Spot, providing up to a 70% discount on compute costs.
