...
2. **On-Demand Fargate for Bot Reliability:** Trading bots run on standard On-Demand Fargate (`weight = 100`), ensuring 100% uptime with zero involuntary Spot eviction interruptions during active trade lifecycles, while still avoiding dedicated EC2 server overhead.
