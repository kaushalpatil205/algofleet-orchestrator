...
# Binance lookback candle counts
LOOKBACK_5M  = 2500
LOOKBACK_1M  = 6000
LOOKBACK_2H  = 500
LOOKBACK_4H  = 300
...
def run_live_scan():
    ...
    df5_raw = fetch_candles(SYMBOL, "5m", LOOKBACK_5M)
    df1_raw = fetch_candles(SYMBOL, "1m", LOOKBACK_1M)
    df2h_raw = fetch_candles(SYMBOL, "2h", LOOKBACK_2H)
    df4h_raw = fetch_candles(SYMBOL, "4h", LOOKBACK_4H)
    df1d_raw = fetch_candles(SYMBOL, "1d", LOOKBACK_1D)
