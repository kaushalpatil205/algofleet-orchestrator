...
import trade_db
trade_db.init("S17-M1M2-V1-FOREX-SELL", _config.get("TRADE_DB_URL", ""), magic=MAGIC, bridge_url=MT5_BRIDGE_URL)




INSTRUMENTS = ["USDJPY", "EURUSD", "USOIL"]

BASE_LOG_DIR = Path("./bridge/Strategy 17 M1 M2 Variation 1 Forex Live Logs")
