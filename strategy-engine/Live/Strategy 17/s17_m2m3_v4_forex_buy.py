...
strategy = make_strategy(Spec(
    id='S17-M2M3-V4-FOREX-BUY',
    label='S17 M2M3 V4 · Forex',
    ...
    log_dir='./bridge/Strategy 17 M3 M2 Variation 4 Forex Live Logs',
), entry=__file__)
