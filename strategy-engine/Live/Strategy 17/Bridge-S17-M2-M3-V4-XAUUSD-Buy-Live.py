...
import trade_db
trade_db.init("S17-M2M3-V4-XAUUSD-BUY", _config.get("TRADE_DB_URL", ""), magic=MAGIC, bridge_url=MT5_BRIDGE_URL)
...
BASE_LOG_DIR = Path("./bridge/Strategy 17 M3 M2 Variation 4 XAUUSD Buy Live Logs")
...
def main():
    log("=" * 60)
    log("🚀 Strategy 17 M3 M2 Variation 4 XAUUSD BUY LIVE SCANNER")
    log("=" * 60)
